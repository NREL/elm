...
from elm.version import __version__ as v
...
latex_documents = [
    (master_doc, 'elm.tex', 'elm Documentation',
     'Grant Buster', 'manual'),
]
...
man_pages = [
    (master_doc, 'elm', 'elm Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'elm', 'elm Documentation',
     author, 'elm', 'One line description of project.',
     'Miscellaneous'),
]
