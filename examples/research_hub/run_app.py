...
if __name__ == '__main__':
    ...
    msg = """Hello!\nI am the Energy Wizard - Research Hub edition. I have access to 
    the NREL Research Hub which includes researcher profiles as well as NREL Publications. 
    Note that each question you ask is independent. I am not fully conversational yet 
    like ChatGPT is. Here are some examples of questions you can ask me:
